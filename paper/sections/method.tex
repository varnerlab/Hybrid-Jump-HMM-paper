...
(formally introduced in Section~\ref{sec:method-setup}, with
$\teps_i$ assumed independent of $g_m$ and $\E[\teps_i] = 0$) by
...
correction; we return to this in Section~\ref{sec:discussion}.
...
Section~\ref{sec:discussion}. The pipeline (\texttt{Pipeline.jl}, in
...
and the full six-composer sweep reported in
Section~\ref{sec:results} completes within an hour on the same
hardware.
