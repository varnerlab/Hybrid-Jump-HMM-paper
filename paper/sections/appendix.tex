...
$1.5\times 10^{-4}$; the residual-fit JumpHMM generator
(\texttt{jumphmm\_residual}, used by JumpHMM-on-residuals) and the
Gaussian baseline were also centered at zero (mean
$7\times 10^{-5}$ and $2.3\times 10^{-4}$ respectively). The
