...
and the Hill tail-index estimator on the upper $5\%$ of
$|g_i^{(r)}|$; variance preservation was the ratio
...
with standard errors on aggregate pass rates below $0.3\%$; the
simulation seed was fixed at $1234$.
...
$\sim 0.25$ at $\beta \approx 0.3$ to effectively zero past
...
noted in Section~\ref{sec:method-properties}: as
